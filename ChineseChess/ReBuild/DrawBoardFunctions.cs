...
namespace ChineseChess
{
    public static class DrawBoardFunctions
    {
        ...
        static int xOffset = GlobalPosition.XOffset;
        static int yOffset = GlobalPosition.YOffset;
        static int cellSize = GlobalPosition.CellSize;
        static int boardSizeX = GlobalPosition.BoardSizeX;
        static int boardSizeY = GlobalPosition.BoardSizeY;
        static int indicatorToCell = GlobalPosition.IndicatorToCell;
        static int legalMoveBoxSize = GlobalPosition.LegalMoveBoxSize;
